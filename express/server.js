const express = require('express'),                                           // Check 
  ...
  serverless = require('serverless-http'),                                    // Check 
...
const { API_ROOT } = require('../config');                                    // Check
const API_ROUTER = express.Router();                                          // Check 

// Body parser middleware passing data as JSON
app.use(bodyParser.json());                                                   // Check: there app.use(express.json());
...
API_ROUTER
  ...
  */
   ...
   * @returns a new user object in JSON format
   */
  .put('/users/:Username/movies/:MovieID', (req, res) => {
    Users.findOneAndUpdate({ Username: req.params.Username }, {
   ...
   * @params {string} MovieID
   */
  .delete('/users/:Username/movies/:MovieID', (req, res) => {
    Users.findOneAndUpdate({ Username: req.params.Username }, {
